...
// // Use /tmp for Vercel's allowed storage directory
// const upload = multer({ dest: '/tmp/uploads/' })
...
//     // Save merged file in the /tmp directory
...
// module.exports = app // Expose app for serverless function

// // Vercel serverless functions will call this handler
...
app.post('/merge', upload.array('files'), (req, res) => {
  ...
  try {
    ...
    // Save merged file in the /tmp directory for Vercel
    const outputPath = path.join('/tmp', 'merged.xlsx')
    xlsx.writeFile(newWorkbook, outputPath)
